...
const WhyChooseUs = () => {
  return (
    <div className="bg-[#e9f4e7] font-inter bn flex flex-col gap-[24px] ">
      <h2 className="text-[#434343] text-[16px] font-bold ">Why Choose us?</h2>
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 ">
        <div className="bg-blue-50 p-7 py-12 rounded-lg text-left flex flex-col gap-3 ">
          ...
          <p className="text-gray-700 mt-2">
            At P&P International, we ethically source and sustainably create
            products, empowering Nepal's communities while caring for people and
            the planet.
          </p>
        </div>
        ...
        <div className="bg-red-50 p-7 rounded-lg text-left flex flex-col items-start py-12 gap-4 ">
          ...
          <p className="text-gray-700 mt-2">
            Inspired by Nepal's natural remedies, P&P International blends ancient wisdom
            with modern science to create effective, gentle, and holistic
            wellness products.
          </p>
        </div>
      </div>
